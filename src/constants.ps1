[string[]] $knownEnvVars = @(
    ...
    "UNICORN_LAB_SAMPLE_APP_CDK_PROJ_DIR", "UNICORN_LAB_SAMPLE_APP_CODECOMMIT_REPO_NAME",
    "UNICORN_LAB_LINUX_DOCKER_START", "UNICORN_LAB_LINUX_DOCKER_AMI", "UNICORN_LAB_LINUX_DOCKER_INSTANCE_SIZE",
    "UNICORN_LAB_AWS_RIP_ECR", "UNICORN_LAB_AWS_RIP_CFNS", "UNICORN_LAB_ADMIN_PASSWORD"
)
