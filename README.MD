...
* **UNICORN_LAB_ADMIN_PASSWORD** - optional well-known password to be set for the Administrator user and to be given to lab participants. If not set, AWS EC2 "Get Password" feature will need to be used.
